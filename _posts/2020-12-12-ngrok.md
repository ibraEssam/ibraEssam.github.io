...
This package offers a ROS service to create tunnels using ngrok. You can clone it to your workspace from [here](https://github.com/ibraEssam/ngrok_ros) and build it easily using catkin_make or catkin_build. Then you can run it using rosrun
