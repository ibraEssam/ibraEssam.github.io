...
* [Edrak. C++ Library for Visual SLAM.](https://github.com/ibraEssam/Edrak)
* [Redis-Server. C++ implementation of Redis server.](https://github.com/ibraEssam/redis-server)
* [Pure pursuit ROS package for path tracking.](https://github.com/ibraEssam/pure_pursuit)
* [binance-dca. Python app to setup DCA orders on Binance.](https://github.com/ibraEssam/binance-dca)
* [C++ Implementation of a BlockChain.](https://github.com/ibraEssam/my_blockchain)
* [ngrok-ros. ROS package for ngrok.](https://github.com/ibraEssam/ngrok_ros)
* [CarSim SFML and ROS based Car Simulator.](https://github.com/ibraEssam/CarSim)
* [Concurrent Traffic Simulation.](https://github.com/ibraEssam/Concurrent-Traffic-Simulation-CPP)
* [Linux System Monitor C++.](https://github.com/ibraEssam/CppND-System-Monitor)
* [Route Planning Project using A* C++.](https://github.com/ibraEssam/CppND-Route-Planning-Project)
* [Unscented Kalman Filter to estimate the state of multiple cars.](https://github.com/ibraEssam/SFND_Unscented_Kalman_Filter)
* [Particles Filter C++ Implementation.](https://github.com/ibraEssam/particles_filter)
* [Time To Collision System (TTC) based on Lidar and Camera.](https://github.com/ibraEssam/SFND_3D_Object_Tracking)
* [PointClouds Obstacles Detection, Segmentation and Clustering](https://github.com/ibraEssam/SFND_Lidar_Obstacle_Detection)
* [Jupyter-ROS (Contributor)  ROS Support for jupyter notebooks](https://github.com/RoboStack/jupyter-ros)
* [Longitudinal and Lateral Control in CARLA Simulator](https://github.com/ibraEssam/carla-longlat-control) &emsp; [Video](https://www.youtube.com/watch?v=_ONfGpo1h-4)
* [Road Semantic Segmentation Using Fully Convolutional Network (FCN) ](https://github.com/ibraEssam/sem-seg)
* [Yu-Gi-Oh Video Game in Java](https://github.com/ibraEssam/yu-gi-oh-java) &emsp; [Video](https://www.youtube.com/watch?v=wY9EOFwh1F0)